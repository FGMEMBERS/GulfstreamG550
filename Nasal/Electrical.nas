...
init_switches = func() {
    ...
    append(watt_list,2);
    append(switch_list,"controls/lighting/cockpit-lights");
    append(output_list,"cockpit-lights");
    append(watt_list,2);
    append(switch_list,"controls/lighting/exterior-lights");
    append(output_list,"exterior-lights");
    append(watt_list,2);
